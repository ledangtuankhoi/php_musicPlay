...
class Song
{
    ...
    // public function __construct($song_name,$song_id, $song_cat, $song_album, $song_singer, $song_desc, $song_file, $song_writer, $song_points,$song_img)
    // {
    ...
    public function save()
    {
        ...
        // ('$this->songname','$this->songcat','$this->songsinger','$audio_path','$this->songdesc','$this->songwriter','$filepath')";
        $sql = "INSERT INTO tblsong(songname,songcat,songsinger,songfile,songdesc,songwriter,songimg) VALUES 
